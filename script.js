        ...
        fetch(url)
            ...
            .then(data => {
                ...
                if (descripcion.includes("nub")) {
                    videoUrl = esDeDia ? "https://valeeochoa.github.io/digitalClock/mp4/nubes-dia.mp4" : "https://valeeochoa.github.io/digitalClock/mp4/nubes-noche.mp4";
                } else if (descripcion.includes("lluv") || descripcion.includes("torm")) {
                    videoUrl = esDeDia ? "https://valeeochoa.github.io/digitalClock/mp4/lluvia-dia.mp4" : "https://valeeochoa.github.io/digitalClock/mp4/tormenta-noche.mp4";
                } else if (descripcion.includes("despejado") || descripcion.includes("soleado") || descripcion.includes("claro")) {
                    videoUrl = esDeDia ? "https://valeeochoa.github.io/digitalClock/mp4/soleado.mp4" : "https://valeeochoa.github.io/digitalClock/mp4/noche-despejado.mp4";
                } else {
                    videoUrl = esDeDia ? "https://valeeochoa.github.io/digitalClock/mp4/lluvia-dia.mp4" : "https://valeeochoa.github.io/digitalClock/mp4/noche-despejado.mp4";
                }
